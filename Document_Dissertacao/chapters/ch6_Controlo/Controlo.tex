...
Onde $K$ representa o ganho estático do sistema e $\tau$ corresponde à constante de tempo mecânica, diretamente associada à relação entre a inércia e o amortecimento do eixo ($\tau = J/B$). A presença do integrador puro na Equação~\ref{eq:funcao_transferencia} reflete a transição natural da malha de velocidade para a malha de posição angular.

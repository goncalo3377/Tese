...
\thesistitle{Desenvolvimento de um Sistema Gimbal de
Seguimento Visual para Neutralização de UAV
Utilizando Laser} % Escreva o título da tese, pode referenciar o titulo ao longa da dissertação utilizando o comando (\ttitle)
...
\author{Gonçalo José Silva Ribeiro} % % Escreva o seu nome completo, pode referenciar o autor ao longa da dissertação utilizando o comando (\authorname)

\authorshort{Gonçalo Ribeiro} % % Escreva o seu 1º e último nome, pode referenciar o autor ao longa da dissertação utilizando o comando (\authorname)
...
\supervisor{Bruno Duarte Damas} % O nome do seu supervisor, isto é usado na página da contra capa,  poderá referenciar-lo ao longo do seu trabalho com o comando (\supname)

\supervisorshort{Bruno Damas} %Nome do seu orientador (1º e último), isto é usado na página da contra capa, poderá referenciar-lo ao longo do seu trabalho com o comando (\supsname)

\cosupervisor{Vitor Rodrigues Viegas} % O nome do seu co-orientador, isto é usado na página da contra capa,  poderá referenciar-lo ao longo do seu trabalho com o comando (\cosupname) (comenta, se não tiveres co-orientador)

\cosupervisorshort{Vitor Viegas} %Nome do seu co-orientador (1º e último), isto é usado na página da contra capa, poderá referenciar-lo ao longo do seu trabalho com o comando (\cosupsname)
...
\input{chapters/Enquadramento_teorico/Enquadramento_Teorico}
\input{chapters/Estado_da_Arte/Estado_da_Arte}
...
\input{chapters/ch5_Estrutura/Estrutura}
\input{chapters/ch6_Controlo/Controlo}
%\input{ch5/chapter5}

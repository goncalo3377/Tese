...
\thesistitle{Desenvolver e Validar um Sistema Laser Autónomo fiável, de baixo custo para neutralizar/abater drones} % Escreva o título da tese, pode referenciar o titulo ao longa da dissertação utilizando o comando (\ttitle)
...
\supervisorshort{Duarte Damas} %Nome do seu orientador (1º e último), isto é usado na página da contra capa, poderá referenciar-lo ao longo do seu trabalho com o comando (\supsname)

\cosupervisor{Nome Co-orientador} % O nome do seu co-orientador, isto é usado na página da contra capa,  poderá referenciar-lo ao longo do seu trabalho com o comando (\cosupname) (comenta, se não tiveres co-orientador)

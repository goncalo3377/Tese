...
\begin{figure}
\centering
\includegraphics{chapters/ch2/assets/electron}
\decoRule
...
\begin{figure}[b]
\centering
\includegraphics[scale=0.5]{chapters/ch2/assets/electron}
\caption[An Electron]{An electron (artist's impression).}
\label{fig:electron}
\end{figure}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{/chapters/ch2/assets/comic}
...
\section{Sistemas de Seguimento a Laser Existentes}

\section{Comparação de Algoritmos de Seguimento em Tempo Real}
